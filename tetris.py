...
ORANGE      = (155, 105,   0)
LIGHTORANGE = (175, 125,  20)
PINK        = (155,   0, 155)
LIGHTPINK   = (175,  20, 175)
...
def drawBoard(board):
    ...
    pygame.draw.rect(DISPLAYSURF, GAMEBG, (XMARGIN, TOPMARGIN, BOXSIZE * BOARDWIDTH, BOXSIZE * BOARDHEIGHT))
